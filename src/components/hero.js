  ...
  return (
    <div className="flex flex-1 px-5 py-16 sm:px-8 lg:px-20 lg:py-32">
      <div className="flex flex-1 flex-col gap-4 lg:gap-4">
        ...
        <button className="w-fit text-xl font-semibold text-green-600 border-[3px] rounded-[18px] border-[#101010] py-3 px-5 main-cta-shadow mt-3 lg:py-4 lg:px-6 md:text-xl lg:text-2xl">
          How it works
        </button>
      </div>
    </div>
